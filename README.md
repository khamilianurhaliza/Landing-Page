...
<img src="https://capsule-render.vercel.app/api?type=waving&height=250&color=0:4F46E5,50:6366F1,100:8B5CF6&text=🚀%20LANDING%20PAGE&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=40"/>
...
<img src="assets/Beranda.png" width="90%" alt="Landing Page Preview" style="max-width:1000px;"/>
...
1. Hero (Frame 1) — Jasa Pembuatan Website
	...
	![Frame 1 - Hero](assets/Beranda.png)
...
2. Seksi Jasa & Keunggulan (Frame 2)
	...
	![Frame 2 - Services](assets/Layanan.png)
...
3. Paket Harga (Frame 3)
	...
	<div align="center">
	![Price - 1](assets/PriceList-1.png){: width="30%" style="margin:8px;"}
	![Price - 2](assets/PriceList-2.png){: width="30%" style="margin:8px;"}
	![Price - 3](assets/PriceList-3.png){: width="30%" style="margin:8px;"}
	</div>
...
4. Portfolio & Klien (Frame 4)
	...
	![Frame 4 - Portfolio](assets/OurClient.png)
...
5. Proses Pemesanan (Frame 5)
	...
	![Frame 5 - Process](assets/Layanan.png)
...
6. Jasa Redesign & Mengapa Harus (Frame 6)
	...
	![Frame 6 - Redesign & Packages](assets/PriceList-2.png)
